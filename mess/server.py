...
from server_gui import MainWindow, gui_create_model, HistoryWindow, create_stat_model, ConfigWindow, ClearHistoryWindow
...
def main():
    ...
    def clear_history():
        global clear_history_window
        clear_history_window = ClearHistoryWindow()
        clear_history_window.ok_btn.clicked.connect(clear_serv_history)
        # clear_history_window.show()

    def clear_serv_history():
        global clear_history_window
        database.clear_server_history()
        server.database.clear_server_history()
        # print(f'{server.database} бесит')
        clear_history_window.close()
    ...
    main_window.clear_history.triggered.connect(clear_history)
