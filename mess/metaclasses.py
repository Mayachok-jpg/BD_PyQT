...
class ServerVerifier(type):
    def __init__(cls, clsname, bases, clsdict):
        ...
        # {'__init__': < function # Server.__init__ at 0x00000224600620D0 >,
        # '__module__': '__main__',
        # '__qualname__': 'Server',
        # 'init_socket': < function Server.init_socket at 0x0000022460062160 >,
        # 'main_loop': < function Server.main_loop at 0x00000224600621F0 >,
        # 'process_client_message': < function Server.process_client_message at 0x0000022460062310 >,
        # 'process_message': < function Server.process_message at 0x0000022460062280 >}
